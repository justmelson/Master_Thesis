...
system_costs["nuclear"] = sum(model.generators_built["nuclear",year].value * 
                             model.fixed_costs["nuclear",year].value/1e6 * 
                             sum(1/(1+r)**(yearb-years[0]) for yearb in years 
                                 if ((yearb>=year) and (yearb < year + parameters.at['lifetime',"nuclear"])))  
                             for year in years)
...
for year in years:    
    for tech in techs:
        if parameters.at["learning parameter",tech] == 0:
            ...
            capcost.at[year,tech] = (parameters.at["current capital cost",tech] * 
                                     (1+sum(model.generators_built[tech,yeart].value 
                                            for yeart in years if yeart < year)*greenfield_df[tech])**
                                     (-parameters.at["learning parameter",tech])) #EUR/MW
    for tech in storage_techs:
        if store_param.at["learning parameter",tech] == 0:
            capcost.at[year,tech] = store_param.at["current capital cost",tech] #EUR/MW
        else:
            capcost.at[year,tech] = store_param.at["current capital cost",tech] *(1+sum(model.storage_built[tech,yeart].value 
...
fig.savefig("Results/Exp1/figures/{}-dispatch.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-dispatchallyears.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-dispatch4days.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-capacity.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-new_capacity.png".format(filename),transparent=True)
...
ax.set_xlabel("year")
ax.set_ylabel("simple LCOE [EUR/MWh]")
# ax.set_yscale("log")
# ax.set_ylim([0,150])
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-LCOE.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-capex.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-SOC.png".format(filename),transparent=True)
...
ax.legend(bbox_to_anchor=(1, 1.05), ncol=1, fancybox=False, shadow=False)
ax.legend().set_visible(lgnd)
fig.savefig("Results/Exp1/figures/{}-SOCallyears.png".format(filename),transparent=True)
...
level_cost.to_excel("Results/Exp1/LCOE_{}.xlsx".format(filename))
fixed_cost.to_excel("Results/Exp1/annuity_costs_{}.xlsx".format(filename))
capcost.to_excel("Results/Exp1/capital_costs_{}.xlsx".format(filename))
