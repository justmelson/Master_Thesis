...
store_param.loc["current capital cost"] = [annuity(20,r)*1042000*(1+540),
...
CC_param.loc["current capital cost"] = [annuity(costs.at['direct air capture','lifetime'],r)*costs.at['direct air capture','investment']*(1+costs.at['direct air capture','FOM']), #EUR/(tCO2/h)
                                        annuity(costs.at['cement capture','lifetime'],r)*costs.at['cement capture','investment']*(1+costs.at['cement capture','FOM'])]
